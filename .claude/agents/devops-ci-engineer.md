...
This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/devops-ci-engineer.md.
...
1. Read .qfai/assistant/agents/devops-ci-engineer.md and follow its output format.
