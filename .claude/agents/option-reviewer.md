# Option Reviewer (Claude Code wrapper)

## Purpose

This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/option-reviewer.md.
