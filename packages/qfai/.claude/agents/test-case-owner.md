# Test Case Owner (Claude Code wrapper)

## Purpose

This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/test-case-owner.md.
...
1. Read .qfai/assistant/agents/test-case-owner.md and follow its output format.
