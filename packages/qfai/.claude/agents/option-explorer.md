# Option Explorer (Claude Code wrapper)

## Purpose

This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/option-explorer.md.
...
1. Read .qfai/assistant/agents/option-explorer.md and follow its output format.
