...
This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/oq-reviewer.md.
...
1. Read .qfai/assistant/agents/oq-reviewer.md and follow its output format.
