...
- Review gate policies (required/optional layers, default reviewers, optional review modes) are documented in `.qfai/assistant/catalog/review-gate.rules.yml`. This catalog is reference material for agents; it is not machine-enforced.
