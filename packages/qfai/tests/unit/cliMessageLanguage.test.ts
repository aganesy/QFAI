    ...
    async () => {
      ...
      for (const file of files) {
        ...
        content.split(/\r?\n/).forEach((line, index) => {
          ...
          // operator; the generated-file header is shipped prose, not a
          // message, so it takes the documentation rule.
          if (/^\s*(\*|\/\/)/.test(line) || line.includes("# Generated by")) {
            return;
          }
          if (/["'`][^"'`]*npx qfai /.test(line)) {
