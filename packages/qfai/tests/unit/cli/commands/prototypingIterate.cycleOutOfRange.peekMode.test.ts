...
// The hint must match the e2e expectation (US-0012-0137) and the public
// peek-mode invocation pattern: the runtime hint and the e2e fixture read
// identically, so the runtime is the side that aligns to the e2e ledger,
// which never asserts the "(defaults to cycle 9; pass --cycle <n> ...)"
// detail.
const EXPECTED_HINT =
