 ...
 * iterate-context.json). US-0012-0143 covers the read-only
...
describe("US-0012-0143: iterate --check-convergence reports the recorded loop state read-only", () => {
