  ...
  const files: Array<{ name: string; lines: string[] }> = [
    ...
    },
    {
      ...
      lines: [
        ...
        "| ------------ | --------------- | ------------------- |",
        "| loading | Loading delays can hide the main action | Reflect `required_states` in `uiux/40_contracts.md` |",
        "| error | Retry and recovery paths need explicit review | Final state contract lives in `uiux/40_contracts.md` |",
        "",
