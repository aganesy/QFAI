...
const KNOWN_OPEN_BUT_TESTED: readonly string[] = [
  ...
  "spec-0012 TDD-0366 todo TC-0012-0322",
  "spec-0012 TDD-0389 todo TC-0012-0378",
  "spec-0012 TDD-0390 todo TC-0012-0379",
  "spec-0012 TDD-0391 todo TC-0012-0380",
  "spec-0012 TDD-0392 todo TC-0012-0392",
  "spec-0012 TDD-0393 todo TC-0012-0370",
  "spec-0012 TDD-0394 todo TC-0012-0395",
  "spec-0012 TDD-0395 todo TC-0012-0354",
  "spec-0012 TDD-0396 todo TC-0012-0356",
  "spec-0012 TDD-0397 todo TC-0012-0386",
  "spec-0012 TDD-0398 todo TC-0012-0391",
  "spec-0012 TDD-0399 todo TC-0012-0362",
  "spec-0012 TDD-0400 todo TC-0012-0363",
  "spec-0012 TDD-0415 todo TC-0012-0396",
  "spec-0012 TDD-0416 todo TC-0012-0397",
  "spec-0012 TDD-0421 todo TC-0012-0401",
  "spec-0012 TDD-0422 todo TC-0012-0402",
  "spec-0012 TDD-0423 todo TC-0012-0403",
  "spec-0012 TDD-0424 todo TC-0012-0404",
  "spec-0012 TDD-0428 todo TC-0012-0408",
  "spec-0012 TDD-0429 todo TC-0012-0409",
  "spec-0012 TDD-0436 todo TC-0012-0416",
  "spec-0012 TDD-0437 todo TC-0012-0417",
  "spec-0012 TDD-0438 todo TC-0012-0418",
  "spec-0012 TDD-0443 todo TC-0012-0423",
  "spec-0012 TDD-0453 todo TC-0012-0433",
  "spec-0012 TDD-0456 todo TC-0012-0436",
  "spec-0012 TDD-0457 todo TC-0012-0437",
  "spec-0012 TDD-0459 todo TC-0012-0459",
  "spec-0012 TDD-0465 todo TC-0012-0460",
  "spec-0012 TDD-0486 todo TC-0012-0457",
  "spec-0012 TDD-0489 todo TC-0012-0470",
  "spec-0012 TDD-0498 todo TC-0012-0450",
  "spec-0012 TDD-0499 todo TC-0012-0451",
  "spec-0012 TDD-0500 todo TC-0012-0452",
  "spec-0012 TDD-0507 todo TC-0012-0468",
  // Split out of a reopened row by the Change Request that reopened it. Each
  // names a case a test already annotates, so it is listed from the start.
  "spec-0012 TDD-0590 todo TC-0012-0356",
  "spec-0012 TDD-0591 todo TC-0012-0362",
  "spec-0012 TDD-0592 todo TC-0012-0409",
  "spec-0012 TDD-0593 todo TC-0012-0409",
  "spec-0012 TDD-0594 todo TC-0012-0409",
  "spec-0012 TDD-0595 todo TC-0012-0409",
  "spec-0012 TDD-0596 todo TC-0012-0417",
  "spec-0012 TDD-0597 todo TC-0012-0417",
  "spec-0012 TDD-0598 todo TC-0012-0417",
  "spec-0012 TDD-0599 todo TC-0012-0418",
  "spec-0012 TDD-0600 todo TC-0012-0418",
  "spec-0012 TDD-0601 todo TC-0012-0418",
  "spec-0012 TDD-0602 todo TC-0012-0423",
  "spec-0012 TDD-0603 todo TC-0012-0423",
  "spec-0012 TDD-0604 todo TC-0012-0423",
  "spec-0012 TDD-0605 todo TC-0012-0423",
  "spec-0012 TDD-0606 todo TC-0012-0436",
  "spec-0012 TDD-0607 todo TC-0012-0436",
  "spec-0012 TDD-0608 todo TC-0012-0436",
  "spec-0012 TDD-0609 todo TC-0012-0459",
  "spec-0012 TDD-0610 todo TC-0012-0460",
  "spec-0012 TDD-0611 todo TC-0012-0460",
  "spec-0012 TDD-0612 todo TC-0012-0457",
  "spec-0012 TDD-0613 todo TC-0012-0457",
  "spec-0012 TDD-0614 todo TC-0012-0450",
  "spec-0012 TDD-0615 todo TC-0012-0452",
  "spec-0012 TDD-0616 todo TC-0012-0452",
  "spec-0012 TDD-0617 todo TC-0012-0452",
  "spec-0012 TDD-0618 todo TC-0012-0468",
  "spec-0012 TDD-0619 todo TC-0012-0468",
  "spec-0012 TDD-0620 todo TC-0012-0468",
  ...
  "spec-0017 TDD-0101 todo TC-0017-0092",
  ...
  "spec-0017 TDD-0107 todo TC-0017-0093",
