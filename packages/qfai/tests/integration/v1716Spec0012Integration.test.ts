...
// QFAI:SPEC-0012:TC-0012-0285 (superseded by spec-0017 REQ-0006, REQ-0007)
// Legacy capture-screenshots.js was removed; the Playwright CLI command plan
// generated by core/prototyping/playwrightCliPlan.ts now defines the
// input/output contract. Covered by tests/core/prototyping/playwrightCliPlan.test.ts.

// QFAI:SPEC-0012:TC-0012-0286 (superseded by spec-0017 REQ-0006)
// Ordering/naming of evidence is now driven by cycleScreenshotPath /
// cycleHtmlPath / cycleSnapshotPath in core/prototyping/types.ts.
