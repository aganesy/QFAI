 ...
 */
// QFAI:SPEC-0012:TC-0012-0493
// QFAI:SPEC-0012:TC-0012-0494
...
describe("qfai-prototyping in a workflow run", () => {
  it("TC-0012-0493 (TDD-0580): A work order confines the stage to its target spec", async () => {
  ...
  it("TC-0012-0494 (TDD-0581): A target that is not UI-bearing is returned blocked", async () => {
    const text = await scopeSection();
    expect(text, "the ## Work order scope section exists").not.toBe("");
    expect(text).toMatch(
