/**
 * Integration: the ATDD stage follows the stage-skill handover.
 *
...
describe("qfai-atdd in a workflow run", () => {
  it("TC-0008-0019 (TDD-0027): The ATDD Stage Follows the Stage-Skill Handover", async () => {
    const text = flat(
      sectionOf(
    ...
    const skill = await readShipped("skills/qfai-atdd/SKILL.md");
    const citing = skill
      .split("\n")
