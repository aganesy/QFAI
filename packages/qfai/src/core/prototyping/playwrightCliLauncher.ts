/**
 * Legacy module — a thin re-export.
 *
 * The canonical module is `playwrightLauncher.ts`. This file exists so
 * external imports of `resolvePlaywrightCliLauncher` and the legacy type names
 * keep compiling.
 *
...
export {
  ...
  // symbol is intentional so legacy importers keep compiling.
