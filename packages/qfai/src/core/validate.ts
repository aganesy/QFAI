...
async function runDiscussionValidators(
  ...
  return [
    // A project reaching this profile may already carry a root DESIGN.md, and
    // the gate has to be able to see whether it parses before a later stage
    // freezes it. Only the parse half — the lock comparison is
