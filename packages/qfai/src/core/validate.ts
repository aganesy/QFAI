...
import {
  ...
  validatePrototypingCandidateConcept,
...
async function runSddValidators(
  ...
  return [
    ...
    ...(await validateDesignContractReadiness(root, config, { stage: "sdd" })),
...
async function runPrototypingValidators(
  ...
  return [
    ...
    ...(await validateDesignContractReadiness(root, config, { stage: "prototyping" })),
    ...(await validatePrototypingCandidateConcept(root, config)),
