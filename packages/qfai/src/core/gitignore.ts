...
import { CANONICAL_TIMESTAMP_GLOB } from "./packLocator.js";
...
export const QFAI_GITIGNORE_GOVERNANCE_NEGATIONS: readonly string[] = [
  ...
  // The discussion stage's evidence, for the same reason: `QFAI-GRILL-001` reads
  // the latest run's `## Grilling Session` section.
