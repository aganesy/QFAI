...
export const ISSUE_EXPECTED_BY_CODE: Record<string, string> = {
  ...
  "QFAI-SKILLS-015":
    "Every skill carries both fields a host registers it by: a `name:` that is its own directory, in lowercase letters, digits and single hyphens to 64 characters, and a `description:` with text in it, to 1024 — a skill that should not be offered to the model declares `disable-model-invocation: true` and keeps the description, rather than dropping the field and losing the registration with it.",
