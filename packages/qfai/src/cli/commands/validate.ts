...
export const ISSUE_EXPECTED_BY_CODE: Record<string, string> = {
  ...
  "QFAI-TDDLIST-023":
    "Every `done` row names a test case that a test file annotates, so the row's completion rests on a test a runner selects rather than on a document that only lists the case.",
