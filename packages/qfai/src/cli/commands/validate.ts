...
const ISSUE_EXPECTED_BY_CODE: Record<string, string> = {
  ...
  "QFAI-RPACK-006":
    "Legacy require-* serial packs are migration warnings in v1.4.35.",
  "QFAI-DISCUSS-023":
  ...
  "QFAI-DISCUSS-028":
    "Legacy discuss serial packs are migration warnings in v1.4.35.",
  ...
  "QFAI-REVIEW-007":
    "Each review summary satisfies the v1.4.35 minimum schema.",
  "QFAI-PROT-101":
  ...
  "QFAI-PROT-233":
    "Interactive uiFidelity records at least one mockPaths status=pass entry (warning in v1.4.35).",
  "QFAI-CONTRACT-030":
