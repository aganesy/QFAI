...
export const ISSUE_EXPECTED_BY_CODE: Record<string, string> = {
  ...
  "QFAI-RESEARCH-015": "Every `sources[]` entry declares its `id`.",
  "QFAI-RESEARCH-016":
    "Every `best_practices[]` / `anti_patterns[]` entry declares `id`, `category`, `title`, `description` and `source_id`.",
  "QFAI-RESEARCH-017": "Every `reflection[]` entry declares `source_id` and `finding`.",
  "QFAI-RESEARCH-018":
...
export const ISSUE_FIX_BY_CODE: Record<string, string> = {
  ...
  "QFAI-RESEARCH-015": "Give the `sources[]` entry an `id` (`SRC-NNNN`).",
  "QFAI-RESEARCH-016":
    "Fill the entry's missing `id` / `category` / `title` / `description` / `source_id` fields.",
  "QFAI-RESEARCH-017": "Fill the reflection entry's missing `source_id` / `finding` fields.",
  "QFAI-RESEARCH-018":
