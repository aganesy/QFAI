...
Options:
  --root <path>   対象ディレクトリ
  --dir <path>    init の出力先
  --force         init: .qfai/assistant/{skills,agents}/** と publish 先 skills/agents、および qfai 提供の .github/copilot-instructions.md / .github/instructions/** / 統合 README を上書き（assistant/manifest/** を含むそれ以外は既存があればスキップ）
