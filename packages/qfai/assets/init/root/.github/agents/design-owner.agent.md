# Design Owner (GitHub Copilot Custom wrapper)

## Purpose

This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/design-owner.md.
