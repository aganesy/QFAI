...
This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/oq-harvester.md.
...
1. Read .qfai/assistant/agents/oq-harvester.md and follow its output format.
