# Project Lead (GitHub Copilot Custom wrapper)

## Purpose

This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/project-lead.md.
...
1. Read .qfai/assistant/agents/project-lead.md and follow its output format.
