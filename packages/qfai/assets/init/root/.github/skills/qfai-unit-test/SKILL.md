---
name: qfai-unit-test
description: QFAI: qfai-unit-test (GitHub Copilot Agent skill wrapper)
---
...
- .qfai/assistant/skills/qfai-unit-test/SKILL.md
...
- Delegate: TestWriter, EdgeCaseAnalyst create first drafts of unit test drafts and edge-case notes.
