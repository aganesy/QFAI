---
name: qfai-implement
description: QFAI: qfai-implement (GitHub Copilot Agent skill wrapper)
---
...
- Delegate: Implementer, Integrator create first drafts of implementation drafts and integration notes.
