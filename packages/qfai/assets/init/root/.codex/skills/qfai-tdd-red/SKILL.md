---
name: qfai-tdd-red
description: QFAI: Implement tests first (TDD Red)
---

This skill is a thin wrapper that forwards to the canonical QFAI prompt in this repository:

- .qfai/assistant/prompts/qfai-tdd-red.md

How to invoke (Codex CLI):

- Select the `qfai-tdd-red` skill, or reference it by name and provide your request.
