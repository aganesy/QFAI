...
This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/qa-lead.md.
...
1. Read .qfai/assistant/agents/qa-lead.md and follow its output format.
