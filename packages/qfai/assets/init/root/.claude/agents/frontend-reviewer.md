# Frontend Reviewer (Claude Code wrapper)

## Purpose

This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/frontend-reviewer.md.
...
1. Read .qfai/assistant/agents/frontend-reviewer.md and follow its output format.
