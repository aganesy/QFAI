# Requirements Analyst (Claude Code wrapper)

## Purpose

This is a thin wrapper for Claude Code agents. The canonical role card lives in .qfai/assistant/agents/requirements-analyst.md.
...
1. Read .qfai/assistant/agents/requirements-analyst.md and follow its output format.
