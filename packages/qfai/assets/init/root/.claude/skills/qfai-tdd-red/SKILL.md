---
name: qfai-tdd-red
description: QFAI: qfai-tdd-red (Claude Code skill wrapper)
---
...
- Delegate: TestWriter, EdgeCaseAnalyst create first drafts of failing tests and edge-case analysis artifacts.
