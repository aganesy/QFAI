...
- This is a legacy entrypoint. You MUST follow `.qfai/assistant/prompts/qfai-tdd-green.md`.
...
- [ ] Followed `.qfai/assistant/prompts/qfai-tdd-green.md` without omissions.
