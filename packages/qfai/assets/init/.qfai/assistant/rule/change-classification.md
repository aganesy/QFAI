...
| -------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **Initial**    | New capability/artifact without changing existing behavior | New command/prompt, new story-tree template, new validator rule                                            | New tests are expected. Update README/templates.                     |
...
| **@db**   | Persisted data formats or DB contracts are involved          | `<paths.contractsDir>/db/*` (default `.qfai/spec/03_contract/db/*`), SQL contracts, ledger formats, report data structure |
