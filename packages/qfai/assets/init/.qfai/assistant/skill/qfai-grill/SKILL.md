...
`.qfai/assistant/skill/qfai-grilling/SKILL.md` is not present and that
...
1. Read `.qfai/assistant/skill/qfai-grilling/SKILL.md`.
...
- The method this skill runs: `.qfai/assistant/skill/qfai-grilling/SKILL.md`
