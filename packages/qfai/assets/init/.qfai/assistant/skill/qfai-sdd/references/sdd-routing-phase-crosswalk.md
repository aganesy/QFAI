...
| `design`          | Stage 2 policy and flows; Stage 3 stories and examples; Stage 4 contracts and rules; the concrete-abstract cycle | `solution-architect` accepts the connected BF → US → AC → EX ← BR design and contract realization before the quality gate. |
...
traceable test obligations during design. An instance of it that wrote no BR is the finder of the concrete-abstract
cycle (`concrete-abstract-cycle.md`). A UI-bearing target also routes the configured experience and surface roles.
