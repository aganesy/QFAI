...
| v1.7.13 (進行中)    | Canonical Sidecar Convergence — selected direction to 30_comparison.md, sidecar-first read order, DDS/anchor vocabulary removal, validator semantics rewrite, template-validator self-consistency                                                                                                                                                                              |
