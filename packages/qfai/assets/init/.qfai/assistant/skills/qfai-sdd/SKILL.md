...
When there is no discussion pack at all and specs already exist (import-lite entrypoint), record the input source instead: write `.qfai/evidence/import-lite-<timestamp>.md` from `templates/evidence/import-lite.md` before editing any spec. Validator: `QFAI-IMPLITE-001`.
