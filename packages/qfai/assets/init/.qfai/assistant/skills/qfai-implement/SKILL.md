...
- `Round N: RED failure mode` — `assertion` | `expected-error` | `falsifiability`, classifying that round's RED. There is no admissible value for a load error (`references/red-admissibility.md`)
