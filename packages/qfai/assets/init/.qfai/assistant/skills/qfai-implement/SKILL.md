...
evidence the reviewers audit. Naming only `implement-<spec-id>.md` here split an `E2E` row in two. The verdict fields are appended **after** items 7-8. A phase-authored evidence file
