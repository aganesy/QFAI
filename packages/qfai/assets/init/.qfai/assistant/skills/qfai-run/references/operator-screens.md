...
| Kind       | How it is put                                                                                                                        |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `create`   | Two options, create it or not, each saying what follows, and a recommendation citing the evidence that no capability covers the goal |
...
- A `create` question is the only one a feature run adds. The announcement
  follows its answer and does not repeat it.
