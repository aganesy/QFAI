...
- P1: `.qfai/assistant/constitution/*`, and `.qfai/assistant/skills/qfai-grilling/SKILL.md` before either session — the one before the loop and the one row `U` resumes
...
`.qfai/assistant/skills/qfai-grilling/SKILL.md` before starting either session**
