...
title: QFAI SDD Refinement (Deprecated Wrapper)
...
| ---- | ---------------- | ---------- | ------------ | ------------- | -------------------- |
| 1    | Reviewer         | Wrapper compliance check | `.qfai/assistant/skills/qfai-sdd-refinement/SKILL.md` | completion message | PASS/REVISE |
...
- This wrapper is notice-only and must not perform real SDD processing.
