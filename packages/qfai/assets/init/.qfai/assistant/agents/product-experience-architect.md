...
- Evaluator axes (information architecture / navigation flow / usability / functionality) are fixed by `.qfai/assistant/skills/qfai-prototyping/references/reviewer-prompt.md`, not sidecar files
