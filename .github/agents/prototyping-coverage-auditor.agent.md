# Prototyping Coverage Auditor (GitHub Copilot Custom wrapper)

## Purpose

This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/prototyping-coverage-auditor.md.
...
1. Read .qfai/assistant/agents/prototyping-coverage-auditor.md and follow its output format.
