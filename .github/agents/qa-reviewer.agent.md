...
This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/qa-reviewer.md.
...
1. Read .qfai/assistant/agents/qa-reviewer.md and follow its output format.
