# Test Engineer (GitHub Copilot Custom wrapper)

## Purpose

This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/test-engineer.md.
...
1. Read .qfai/assistant/agents/test-engineer.md and follow its output format.
