# Runtime Gatekeeper (GitHub Copilot Custom wrapper)

## Purpose

This is a thin wrapper for GitHub Copilot Custom agents. The canonical role card lives in .qfai/assistant/agents/runtime-gatekeeper.md.
...
1. Read .qfai/assistant/agents/runtime-gatekeeper.md and follow its output format.
