...
| EX-0001-0187-05 | AC-0001-0187-03 | `docs.python.org` → 302 → `nodejs.org` → 302 → `evil-proxy.com`, with an allowlist of both docs domains                                                              | Blocked at the third hop, and the chain is logged                                                    |
