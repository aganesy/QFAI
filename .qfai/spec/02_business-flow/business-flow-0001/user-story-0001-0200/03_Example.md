...
| --------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| EX-0001-0200-01 | AC-0001-0200-01 | A start input whose `harness.host` is `copilot`, and a `claude-code` start input whose capability report declares `delegateSubAgent` missing | Each is refused `fail-closed` with cause `unsupported-capability` naming the host or the capability, and no run directory |
