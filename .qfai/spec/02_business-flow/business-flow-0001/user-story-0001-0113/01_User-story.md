# US-0001-0113: Low-cost per-iteration evidence

## User Story

As a maintainer, I want each cycle to require only a per-screen review payload by default, with PNG and HTML capture available by opt-in, so routine iterations remain inexpensive.
...
- Story block: `.qfai/evidence/migration-spec-to-story/retired/spec-0012/02_User-stories.md#us-0012-0104`
