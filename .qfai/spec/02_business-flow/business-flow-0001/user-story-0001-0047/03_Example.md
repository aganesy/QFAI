...
| EX-0001-0047-02 | AC-0001-0047-02 | Given `qfai-implement/SKILL.md` without a trailing `project_memory:` YAML block When `qfai validate` runs | Then an error fires naming `qfai-implement` and the missing block                                                       |
