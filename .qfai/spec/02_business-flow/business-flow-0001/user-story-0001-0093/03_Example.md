...
| EX-0001-0093-04 | AC-0001-0093-02 | `currentId` absent with exactly one pack, `discussion-20260101000000000`; `qfai discussion list --active`                                | Exit 0, `discussion-20260101000000000` on stdout, and a stderr note "no pointer set; single candidate assumed" |
