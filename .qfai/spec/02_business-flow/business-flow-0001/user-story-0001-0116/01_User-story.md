# US-0001-0116: Deterministic design-token violation scan

## User Story

As a reviewer, I rely on a deterministic `findDesignMdViolations(html, designMd)` scan of color, font, radius, and shadow tokens, so token violations prevent a false convergence result.
...
- Story block: `.qfai/evidence/migration-spec-to-story/retired/spec-0012/02_User-stories.md#us-0012-0107`
