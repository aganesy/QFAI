...
As a reviewer (product-surface-reviewer), I want to launch Playwright myself and operate the prototype (click / type / navigate / scroll) per spec × screen (per UI contract × screen on the story tree) so that my qualitative impressions reflect actual operability instead of a pre-generated script transcript. (REQ-0003, CHG-002)
...
- Story block: `.qfai/evidence/migration-spec-to-story/retired/spec-0012/02_User-stories.md#us-0012-0110`
