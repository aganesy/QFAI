...
As a QFAI user, I want a single `/qfai-sdd` command to produce, from a discussion pack, the specification the detected layout calls for — layered spec artifacts (policies + spec-XXXX) in the spec-pack layout, and the policy, business-flow, story and contract layers on the story tree — so that downstream execution skills have complete specifications.
...
- Story block: `.qfai/evidence/migration-spec-to-story/retired/spec-0013/02_User-stories.md#us-0013-0001`
