# US-0001-0124: Certification of frozen UI-contract reviews

## User Story

As a maintainer, I want `qfai prototyping certify` to aggregate per-spec review-payload presence across the cycle-0 frozen spec set so that a missing `<screen>.review.json` for any spec at the accepted iter rejects certify. On the story tree certify aggregates per UI contract across the cycle-0 frozen `uiContractsCovered[]`, and a missing review for any UI contract rejects it. (REQ-0009, CHG-002)
...
- Story block: `.qfai/evidence/migration-spec-to-story/retired/spec-0012/02_User-stories.md#us-0012-0115`
