...
| EX-0001-0183-06 | AC-0001-0183-01 | Research task with max_threads=2 (default) and 5 URLs to fetch                  | Agent fetches URLs 2 at a time in sequence; total fetch operations: 3 batches (2+2+1)                        |
