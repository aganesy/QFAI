...
| BR-0622 | A semantic effect found during a `direct` change reclassifies the run before the edit: `qfai-maintain` edits nothing and returns `needs_repair`, with the finding in `debts`, a `resolvingOwner` the `direct` plan does not name, and an empty `changedFiles`. Invoked by name, it stops and reports that the change is not a maintenance edit.                                                                                                                                                                                                                                                                                                                                                                                                                             | EX-0001-0198-04                                                                                                                                                                                                                                                                                                  |
