...
| BR-0608 | `resume` on a run in `running` whose outstanding work order has no accepted result, as after a lost session or a stop the host could not record, fires `observed-session-interruption` then `reconciled-resume` in the same call and returns that work order again.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | EX-0001-0196-16                                                                                                                                                                                                                                                                                                  |
...
| BR-0628 | A fail-closed cause found at `start` is refused and leaves no run; the causes form the closed set this contract gives, and policy drift is exactly its triggers (a), (b) and (c).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EX-0001-0199-06, EX-0001-0199-05, EX-0001-0200-01                                                                                                                                                                                                                                                                |
