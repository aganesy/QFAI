...
- Each dependency is classed `normative`, `historical_observation` or
  ...
  production change leaves it `valid`. A receipt holds the files its result
  changed, and the write areas covering them, as `current_verification`. The routing
...
| BR-0534 | The answer to a `create` question is recorded only through `decision`, as a `human_decision` bound to the work order's `new_story` slot. An approval with no persisted `authorizationId` authorizes no story-authoring work order: `next` opens a new `create` question for that slot instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | EX-0001-0192-02, EX-0001-0192-44, EX-0001-0195-09                                                                                                                                                                                                                                                                |
| BR-0535 | One approval covers one new-story slot: a CREATE of a story in an existing flow, or a CREATE of a new flow (`flowId: null`) with the stories written under it. A plan that needs two slots opens two `create` questions in one round.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | EX-0001-0192-03                                                                                                                                                                                                                                                                                                  |
...
| BR-0544 | `next` and `resume` return the same work order until a result for it is accepted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EX-0001-0192-12                                                                                                                                                                                                                                                                                                  |
...
| BR-0554 | Only `finish` reports a run complete, and only from `ready`; an unmet `finish` changes no state and lists every unmet condition with its owner.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | EX-0001-0192-22, EX-0001-0196-17                                                                                                                                                                                                                                                                                 |
...
| BR-0556 | A run's completion target is fixed at `start`, and a `working_tree` result is never reported as `qfai_done`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EX-0001-0192-24, EX-0001-0192-41                                                                                                                                                                                                                                                                                 |
...
| BR-0558 | A run carrying unresolved debt does not complete, and debt with no resolving owner is refused at `accept`. A debt only another flow's owner can resolve keeps the run from completing until that flow is repaired outside the run. A debt is resolved once the `finish` validate, or a later accepted result of the stage kind that detected it, no longer reports its `findingCode` at its path.                                                                                                                                                                                                                                                                                                                                                                           | EX-0001-0192-26                                                                                                                                                                                                                                                                                                  |
...
| BR-0568 | A `missing-test` diagnosis for which no example states the case selects `sdd_append` under `missing_example_needed`, then acceptance under `acceptance_obligations_unmet`, then implement and a full verify.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EX-0001-0193-01, EX-0001-0193-13                                                                                                                                                                                                                                                                                 |
| BR-0569 | The `sdd_append` work order carries the diagnosis evidence as the reason for the example it appends, and the stage changes no story statement, criterion or rule statement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EX-0001-0193-02, EX-0001-0192-50                                                                                                                                                                                                                                                                                 |
...
| BR-0573 | `accept` refuses, with reason `example-added`, a result that adds an example to the bound flow, unless it comes from an `sdd`, `sdd_append` or `sdd_delta` stage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EX-0001-0193-06, EX-0001-0193-12                                                                                                                                                                                                                                                                                 |
...
| BR-0576 | A request that no story covers but that states its expected result routes `bounded-change`, not `bugfix`, and a bugfix never changes the normative expectation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | EX-0001-0193-09, EX-0001-0194-04, EX-0001-0192-49                                                                                                                                                                                                                                                                |
| BR-0577 | Reclassifying a route never drops an unfinished obligation, and the work order that follows a replan lists the obligations that remain and the validity of every prior receipt, `valid`, `stale` or `unknown`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | EX-0001-0193-10                                                                                                                                                                                                                                                                                                  |
...
| BR-0580 | Every work order carries the run's history of authors, recommenders and reviewers, and an agent never counts as the independent reviewer of what it authored or recommended.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EX-0001-0194-03, EX-0001-0194-08                                                                                                                                                                                                                                                                                 |
...
| BR-0587 | After a `proceed` answer the run continues with no stage named by the operator, and after a `replan` answer it returns to `routing`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | EX-0001-0195-05, EX-0001-0195-15                                                                                                                                                                                                                                                                                 |
...
| BR-0589 | When one missing value is all that blocks a route, routing asks for it once and then fixes the route; a full discussion pack is created only where product scope, several design decisions or UX direction are open.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | EX-0001-0195-07, EX-0001-0195-08                                                                                                                                                                                                                                                                                 |
...
| BR-0595 | A run record written by a newer package is refused, and a record the core cannot read is reported as legacy and never as a successful run, and it is not counted as a non-terminal run.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | EX-0001-0196-03                                                                                                                                                                                                                                                                                                  |
...
| BR-0597 | A new session told to continue restores the same run, and the CLI starts no session of its own.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | EX-0001-0196-06                                                                                                                                                                                                                                                                                                  |
...
| BR-0600 | A RED receipt holds its obligation fingerprint as normative and its oracle fingerprint as a historical observation, so a later production change leaves it `valid` and a change to its obligation fingerprint makes it `stale`; a GREEN receipt goes `stale` when the files its result changed change.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | EX-0001-0196-08, EX-0001-0196-07                                                                                                                                                                                                                                                                                 |
...
| BR-0602 | A write, or a read of a run file, that fails with `EBUSY`, `EPERM` or `EACCES` is refused `io-error` with the exit code `## Exit codes` gives, and is not retried in a loop.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | EX-0001-0196-10                                                                                                                                                                                                                                                                                                  |
...
| BR-0606 | A `stop` through `decision` takes a run in any non-terminal state to `cancelled`, and nothing is written or asked afterwards.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | EX-0001-0196-14, EX-0001-0199-07                                                                                                                                                                                                                                                                                 |
...
| BR-0608 | `resume` on a run in `running` whose outstanding work order has no accepted result, as after a lost session or a stop the host could not record, fires `observed-session-interruption`, then `reconciled-resume` and returns that work order again, or `reconciled-with-blocker` and leaves the run `blocked` with no work order when a cause or blocker remains.                                                                                                                                                                                                                                                                                                                                                                                                           | EX-0001-0196-16                                                                                                                                                                                                                                                                                                  |
| BR-0609 | Every transition follows the `## State machine` edge table: an operation with no edge from the current state is refused, or for `finish` lists the unmet condition, and the state is unchanged; a terminal run accepts no further event.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EX-0001-0196-17                                                                                                                                                                                                                                                                                                  |
| BR-0610 | A saturated delegation is retried with the 30, 60 and 120 second backoff, at most three times per work order, and an unavailable delegation leaves the run `blocked`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | EX-0001-0196-18, EX-0001-0200-03                                                                                                                                                                                                                                                                                 |
...
| BR-0613 | Reaching the replan budget (three per run) or the automatic-repair budget (three per cause: a finding code and its path) leaves the run `blocked` with blocker `budget-exhausted` and never counts as a pass. `resume` of a run blocked on a spent replan budget reports a fail-closed cause first; otherwise it writes nothing while the routing receipt stays stale, and releases the run once it holds.                                                                                                                                                                                                                                                                                                                                                                  | EX-0001-0196-21, EX-0001-0196-25                                                                                                                                                                                                                                                                                 |
...
| BR-0628 | A fail-closed cause found at `start` is refused and leaves no run; the causes form the closed set this contract gives, and policy drift is its triggers (a), (b) and (c).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | EX-0001-0199-06, EX-0001-0199-05, EX-0001-0200-01, EX-0001-0199-09                                                                                                                                                                                                                                               |
| BR-0629 | A cause found after `start` stops automatic chaining as `## State machine` says, until `resume` finds it cleared or the run is stopped, and the core never rewrites the project's configuration.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EX-0001-0199-07, EX-0001-0196-25                                                                                                                                                                                                                                                                                 |
...
| BR-0642 | A host is claimed as supported only with a green adapter test and a recorded eval result for the current package version whose safety cases all pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | EX-0001-0201-08, EX-0001-0201-09                                                                                                                                                                                                                                                                                 |
...
| BR-0666 | A `missing-test` diagnosis whose first matched ID is an example that states the case selects no story-authoring stage: the plan's acceptance stage under `acceptance_obligations_unmet`, and its implement stage under `diagnosis_missing_test` write that example's test.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | EX-0001-0193-11                                                                                                                                                                                                                                                                                                  |
