...
| BR-0181 | --fail-on 未指定時は常に exit 0。error: error > 0 で exit 1。warning: warning + error > 0 で exit 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | EX-0003-0012-01, EX-0003-0012-02, EX-0003-0012-03, EX-0003-0011-09                  |
...
| BR-0194 | `runtimeDependencies` が空配列の manifest は probe を 1 件も emit しない (false positive 禁止)。manifest 宣言と probe 結果の drift は `R-SKILL-MANIFEST-DRIFT` (SSOT-sync Pair III) を emit する。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | EX-0003-0010-02                                                                     |
