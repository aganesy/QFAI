...
| BR-0043 | `--dry-run` 時はファイル書き込み・symlink 作成・削除を一切行わない                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | EX-0001-0023-01, EX-0001-0025-03                                                    |
...
| BR-0096 | Init generates one `.codex/agents/<name>.toml` profile per canonical card from its frontmatter name, description and kind and its body. Only kind: reviewer gets sandbox_mode = read-only. A plain run preserves an existing profile; --force regenerates it; --dry-run writes no profile. If kind cannot be determined, init skips the profile and reports why.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | EX-0001-0025-02, EX-0001-0025-03                                                    |
