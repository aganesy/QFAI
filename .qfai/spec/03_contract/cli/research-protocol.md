...
| BR-0366 | MCP configuration MUST support both stdio and HTTP transport modes. SSE transport is deprecated and MUST NOT be used.                              | EX-0001-0184-01, EX-0001-0184-02                  |
...
| BR-0369 | SKILL.md MUST be loaded metadata-first (YAML frontmatter only). Full body MUST be deferred until task execution begins.                            | EX-0001-0185-01                                   |
| BR-0370 | Sanitizer MUST remove: (a) control characters, (b) aria-hidden elements, (c) display:none elements. MUST NOT use ML-based detection.               | EX-0001-0186-01, EX-0001-0186-02, EX-0001-0186-03 |
...
| BR-0373 | Redirect targets MUST be validated against the allowlist at each redirect hop. Non-allowlisted redirect target MUST be blocked.                    | EX-0001-0187-02                                   |
...
| BR-0379 | Cache key MUST be hash(URL+etag). Both raw and cleaned content MUST be stored. Default staleness threshold is 24 hours, configurable.              | EX-0001-0183-04, EX-0001-0183-05                  |
