...
| BR-0033-0004 | Corruption detection     | AC-0033-0003               | Handoff artifacts must be validated (JSON parse + schema check) before resume; invalid artifacts trigger fresh start    | Log error with corruption details                         |          |
...
| BR-0033-0008 | Stub-only heuristic      | AC-0033-0008               | Stub detection matches patterns: `throw.*not implemented`, `TODO`/`FIXME` comments, empty function/method bodies        | JS/TS focused; pattern list extensible via config         |          |
