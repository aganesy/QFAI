...
| v1.7.15 (SDD 進行中) | Runtime Truthfulness Hardening — pre-scored l1/l2 path elimination, fail-closed CalibrationLoader, screen-level UiObservation, l2Evidence real artifact derivation, bundleWriter schema v2, validator 14-rule error upgrade, docs/tests reality sync                                                                                                                          |
