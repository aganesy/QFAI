...
| v1.7.14 (完了)    | Canonical Convergence Finalization — strict classification enforcement, namespaced-only prototyping.yaml, current-only shipped SSOT, regression net hardening                                                                                                                                                                                                                  |
| v1.7.15 (完了)    | Runtime Truthfulization — measurement-driven full-harness runtime, evidence schema v2 hardening, trend scan canonicalization to `04_Sources.md`, root/init SSOT unification                                                                                                                                                                                                    |
| v1.7.16 (完了)    | Design Quality Pipeline Expansion — discussion/prototyping design-quality authoring, validator expansion, trend/playbook assets, non-UI safety hardening                                                                                                                                                                                                                       |
| v1.7.17 (完了)    | Delegation Policy Hardening — current operational baseline converged on delegation-failure-hard-stop with simulation wording retired from active instructions                                                                                                                                                                                                                  |
| v1.7.18 (進行中)  | Post-v1.7.17 convergence continuation — docs/spec/review/template cleanup across the current branch, including managed ignore guidance, frozen evidence wording, and remaining current-only SSOT alignment                                                                                                                                                                     |
