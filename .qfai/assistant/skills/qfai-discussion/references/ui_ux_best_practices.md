...
(4-step ordinal: weak / acceptable / strong / exceptional, fixed by the evaluator review
schema in `.qfai/assistant/skills/qfai-prototyping/references/reviewer-prompt.md`) and are not
