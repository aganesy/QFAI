...
| ---- | ---------------- | ------------------------ | ------------------------------------------------ | ------------------ | -------------------- |
| 1    | Reviewer         | Wrapper compliance check | `.qfai/assistant/skills/qfai-tdd-green/SKILL.md` | completion message | PASS/REVISE          |
...
- This wrapper is notice-only and must not perform real TDD green execution.
