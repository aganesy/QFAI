...
- The stage evidence's `## Grilling Session` section carries `Run started`,
  ...
  the chronology is the whole of what the two times are recorded for. Every `Ended` is one of the four endings the rule master
