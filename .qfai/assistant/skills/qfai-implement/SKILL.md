...
- Read order: option comparison (30_option_comparison.md) → selected anchor screen (31_selected_anchor_screen.md) → strategy (10_implementation_strategy.md)
  → taste interview (11_design_taste_interview.md) → trend scan (04_Sources.md) → 3-layer evaluation family (20/21/22/23 + optional 24)
  → screen contracts (40_screen_contracts.md) → review input bundle (50_review_input_bundle.md) → optional design tokens → optional fallback mock → mermaid flows.
