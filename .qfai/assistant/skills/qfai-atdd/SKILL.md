...
Review pack: `.qfai/review/review-<timestamp>/` Review pack seal: <sha256>
```
...
- Layer-pinned coverage, status exemptions and project-wide surface resolution follow CRITICAL CONSTRAINTS.
