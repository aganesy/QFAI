...
- Coverage Depth Matrix is missing, omits the business rule coverage table on a spec that declares `BR-*`, or contains unjustified ❌ cells in either table (normal-path-only coverage is incomplete).
