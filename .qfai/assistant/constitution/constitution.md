...
Only the safety floor in `.agents/rules/minimal-implementation.md` § 2 outranks
this article. This article takes precedence over every other article and over
conflicting instructions in other constitution documents. The unnumbered
Absolute Rule — Output Language remains above all articles.
