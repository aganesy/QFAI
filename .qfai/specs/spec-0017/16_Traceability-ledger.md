...
| BR-0017-0069 | .github/workflows/release.yml         | packages/qfai/tests/scripts/ownWorkflowTopology.test.ts | Independent operation jobs preserve old-tag fallback and workspace isolation.                                                                                      |
| BR-0017-0069 | package.json                          | packages/qfai/tests/scripts/ownWorkflowTopology.test.ts | The four entry points preserve the aggregate command sequence.                                                                                                     |
...
ledger row by any reader — machine or human. `State today` was checked against the tree;
paths shared with `10_Plan.md` have the same state in both files.
...
| `.github/workflows/release.yml`                                             | present     | BR-0017-0015, BR-0017-0016, BR-0017-0018, BR-0017-0019, BR-0017-0020, BR-0017-0056, BR-0017-0057, BR-0017-0069                                                                                                                                                                                                                                          | `packages/qfai/tests/scripts/workflowHygiene.test.ts`, `packages/qfai/tests/scripts/sliceSurfaceAlignment.test.ts` | Workflow hygiene and slice-alignment changes                                             |
