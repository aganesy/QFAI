...
| CAP-0012 | skill      | プロトタイピング (qfai-prototyping)                  | 1 prototype × 最大 15 cycle × UX 中心 4 軸 ordinal 評価 (informationArchitecture / navigationFlow / usability / functionality) × 散文 critique × pivotDirective × layout-anti-pattern catalog (lap-001..008) × DESIGN.md ブランド SSOT (sha256 凍結) で AI 自発的 creative leap を誘発する skill が spec-0012 で定義される |
