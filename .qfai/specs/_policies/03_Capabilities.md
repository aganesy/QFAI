...
| CAP-0012 | skill      | プロトタイピング検証 (qfai-prototyping)       | (v1.x) superseded by the v2.0 single-thread evolution capability listed below at the end of this catalog. |
...
| CAP-0017 | skill      | プロトタイピング v2.0 (single-thread evolution loop) | 1 prototype × 15 cycle × 4 軸 ordinal × 散文 critique × pivot 推奨 × global anti-slop で AI 自発的 creative leap を誘発する skill が spec-0017 で定義される |
