...
- The skill body MUST reference this section as the source of truth. A skill MAY narrow any of the three buckets (drop an entry it cannot reach) but MUST NOT widen one.
