...
```gherkin
# AC-0034-0001: Pipeline completes all stages successfully
...
# AC-0034-0002: Pipeline handles search failure gracefully
...
# AC-0034-0003: Pipeline handles fetch failure gracefully
...
# AC-0034-0004: MCP server integration via templates
...
# AC-0034-0005: MCP server crash detection and fallback
...
# AC-0034-0006: MCP rate limit handling
...
# AC-0034-0007: Research skill progressive disclosure
...
# AC-0034-0008: Invalid SKILL.md handling
...
# AC-0034-0009: Content sanitization blocks injection
...
# AC-0034-0010: Legitimate content passes sanitization
...
# AC-0034-0011: Domain allowlist enforcement
...
# AC-0034-0012: Non-allowlisted domain blocked
...
# AC-0034-0013: Redirect to non-allowlisted domain is blocked
...
# AC-0034-0014: Structured research log completeness
...
# AC-0034-0015: Evaluation golden task execution
...
# AC-0034-0016: HITL gate triggers on high-risk conclusion
...
# AC-0034-0017: HITL gate approval flow
...
# AC-0034-0018: HITL gate rejection flow
...
# AC-0034-0019: Cross-agent configuration compatibility
...
# AC-0034-0020: Sandbox default-deny configuration
...
| ------------ | -------------------------------- | ------------------------------ | -------- |
| AC-0034-0001 | Pipeline completes all stages    | Happy path, US-0034-0001       | Must     |
| AC-0034-0002 | Pipeline handles search failure  | Negative path, US-0034-0001    | Must     |
| AC-0034-0003 | Pipeline handles fetch failure   | Edge case, US-0034-0001        | Must     |
| AC-0034-0004 | MCP server integration           | Happy path, US-0034-0002       | Must     |
| AC-0034-0005 | MCP crash detection and fallback | Negative path, US-0034-0002    | Must     |
| AC-0034-0006 | MCP rate limit handling          | Edge case, US-0034-0002        | Must     |
| AC-0034-0007 | Skill progressive disclosure     | Happy path, US-0034-0003       | Must     |
| AC-0034-0008 | Invalid SKILL.md handling        | Negative path, US-0034-0003    | Should   |
| AC-0034-0009 | Sanitization blocks injection    | Happy path, US-0034-0004       | Must     |
| AC-0034-0010 | Legitimate content passes        | Negative path, US-0034-0004    | Must     |
| AC-0034-0011 | Allowlisted domain succeeds      | Happy path, US-0034-0005       | Must     |
| AC-0034-0012 | Non-allowlisted domain blocked   | Negative path, US-0034-0005    | Must     |
| AC-0034-0013 | Redirect crosses allowlist       | Edge case, US-0034-0005        | Must     |
| AC-0034-0014 | Structured log completeness      | Happy path, US-0034-0006       | Must     |
| AC-0034-0015 | Golden task evaluation           | Happy path, US-0034-0007       | Should   |
| AC-0034-0016 | HITL gate triggers on high-risk  | Happy path, US-0034-0008       | Must     |
| AC-0034-0017 | HITL gate approval               | State transition, US-0034-0008 | Must     |
| AC-0034-0018 | HITL gate rejection              | Negative path, US-0034-0008    | Must     |
| AC-0034-0019 | Cross-agent config compatibility | Happy path, US-0034-0002       | Must     |
| AC-0034-0020 | Sandbox default-deny             | Happy path, US-0034-0005       | Must     |
