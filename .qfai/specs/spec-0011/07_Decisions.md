...
15 items (IDs: DR-0011-0001, DR-0011-0003..DR-0011-0016). DR-0011-0002 is not
...
- Amended by: DR-0011-0014. The skill text this record routes stays. AC-0011-0012, BR-0011-0009 and TC-0011-0013 are removed, so no item or test carries it.

### DR-0011-0004: Texts of AC-0011-0012, BR-0011-0009, EX-0011-0010 and TC-0011-0013 (2026-09-23)

- Status: superseded by DR-0011-0014
...
- Amended by: DR-0011-0014. The plan paragraph stays; it no longer cites BR-0011-0009, and the text has no test of its own.
...
### DR-0011-0014: The record-homes obligations are withdrawn (2026-09-25)

- Status: accepted
- Context: The user decided on 2026-09-25 that no test checks the work-log surface is gone, and that the replacement skill text stays while its tests go. `CR-20260925-0010` records it, and its Triage group for this spec was approved at 2026-09-25T04:52:16Z. The pack's REQ-0007 is now checked by review.
- Decision: Remove AC-0011-0012, BR-0011-0009, EX-0011-0010 and TC-0011-0013, and the `discussion-20260923060900824#REQ-0007` line of `01_Spec.md`. Delete ledger rows TDD-0021..TDD-0023 and tombstone each ID under a new `## TDD-ID reservations` section. DR-0011-0004..DR-0011-0011 and DR-0011-0013 decided the withdrawn items and are superseded. DR-0011-0003 and DR-0011-0012 are amended: the skill text and the plan paragraph they decided stand.
- Consequences: The shipped `/qfai-implement` text that records a stop in `Blocked-By` and sends a decision, a consultation or a discovery to `/qfai-sdd` as a Change Request stays, with no dedicated test. The review that checks REQ-0007 searches the skill for both `.qfai/steering/` and `worklog-entry.schema.md`; NFR-0006 lists only the first.
- Related: AC-0011-0012, BR-0011-0009, EX-0011-0010, TC-0011-0013, TDD-0021, TDD-0022, TDD-0023, CR-20260925-0010. `09_delta.md` DL-0012.
