...
| TC-0026-0020 | L3    | AC-0026-0014, AC-0026-0015 | EX-0026-0021 | Validate uiux/20-23 eval files                                         | 3-layer model and aggregate scoring rules are present and parseable  | 3-layer evaluation model       |
...
| TC-0026-0022 | L3    | AC-0026-0001 | EX-0026-0023 | Validate uiux/40_contracts.md                                          | Screen contract includes route, actor, purpose, primary tasks, required states, transitions, and observable outcomes | Screen contracts minimum schema |
...
| TC-0026-0028 | L3    | AC-0026-0007 | EX-0026-0028 | Check DDS State Coverage has 4 required state bullets                  | All 4 states (empty/loading/error/populated) present as bullets      | DDS DDP-024 regression guard   |
| TC-0026-0029 | L3    | AC-0026-0016 | EX-0026-0029 | Generate uiux/10_strategy.md; inspect YAML for all 5 fields            | All 5 fields present and parseable                                   | v1.7.6 remediation             |
| TC-0026-0030 | L2    | AC-0026-0017 | EX-0026-0030 | Provide strategy with selection_required=true and empty chosen_option; run qfai validate | Actionable error emitted identifying the missing chosen_option       | v1.7.6 remediation             |
| TC-0026-0031 | L2    | AC-0026-0018 | EX-0026-0031 | Provide strategy with chosen_option=none-as-legitimate-outcome and rationale present; run qfai validate | Validation passes; no error emitted                                  | v1.7.6 remediation             |
| TC-0026-0032 | L3    | AC-0026-0019 | EX-0026-0032 | Read finalized uiux/10_strategy.md as reviewer; verify all 5 fields readable | All 5 fields present and human-readable without source access        | v1.7.6 remediation             |
| TC-0026-0033 | L2    | AC-0026-0020 | EX-0026-0033 | Finalize strategy artifact; attempt field modification                 | Modification rejected; all 5 fields immutable post-finalization      | v1.7.6 remediation             |
| TC-0026-0034 | L3    | AC-0026-0021 | EX-0026-0034 | Generate strategy artifact twice from identical input                  | All 5 field values identical across both generations                 | v1.7.6 remediation             |
