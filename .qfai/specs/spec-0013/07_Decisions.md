...
- Status: accepted
- Context: The main branch re-derived this pack under `CR-20260913-0012` and gave `AC-0013-0028`, `BR-0013-0021`, `EX-0013-0021`, `TC-0013-0036`, `TC-0013-0037` and `TDD-0044`..`TDD-0049` to the optional side artifact rules. That record allocated the test case IDs before this change allocated the same IDs to the work-log removal chain, and `CR-20260923-0010` gave `AC-0013-0028` the same meaning.
- Decision: Main's IDs keep their meaning. The work-log removal chain moves to the next free IDs: `AC-0013-0030`, `BR-0013-0023`, `EX-0013-0023`, `TC-0013-0038`, `TC-0013-0039` and `TDD-0110`..`TDD-0115`. `AC-0013-0029`, `BR-0013-0022` and `EX-0013-0022` did not collide and keep theirs.
- Consequences: The titles and annotations of `spec0013RecordHomes.test.ts` and `spec0013ApprovalStop.test.ts` change with the IDs, so the six rows are seeded at `todo` and completed again. Commit messages written before the merge keep the old IDs; `09_delta.md` maps each one.
- Related: AC-0013-0029, AC-0013-0030, BR-0013-0022, BR-0013-0023, EX-0013-0022, EX-0013-0023, TC-0013-0038, TC-0013-0039, TDD-0110..TDD-0115, CR-20260913-0012, CR-20260923-0010
