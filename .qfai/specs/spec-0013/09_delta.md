...
- Items appended: US-0013-0015..US-0013-0017; AC-0013-0043 and AC-0013-0031..AC-0013-0041, AC-0013-0044..AC-0013-0045;
  BR-0013-0024..BR-0013-0035, BR-0013-0037..BR-0013-0038. The examples start at EX-0013-0036 and the test
  cases at TC-0013-0052. No existing item changes: US-0013-0004 and
...
- At the intent-driven entry, BR-0013-0021, EX-0013-0021, TC-0013-0036 and
  TC-0013-0037 were reserved for `CR-20260913-0012`. DELTA-0007 applies that
...
- Resolved pack questions:
  ...
  - `discussion-20260923171450572#OQ-0009`: CLI-WFFILE `### Vocabulary` and
    ...
    `defect-row-seeding`.
- Policy: DR-0299 and DR-0297, cited in `01_Spec.md` `## Applicable Policy`. No
...
- Tags: @docs, @test
- Summary:
  - BR-0013-0024 and AC-0013-0045 state how the other five approval-required
...
- Primary: Follow-up
- Tags: @docs, @test
- Summary: CR-20260925-0020 part A. Five test cases no longer require shipped
  skill text to cite a contract or DR-0297, neither of which ships:
  - TC-0013-0052 states the approval check: the record exists, matches the
    row's operation and capability, and is not stale.
  - TC-0013-0053 states the three staleness conditions, and that the clock
  ...
  IDs are unchanged. TDD-0131, TDD-0132, TDD-0116, TDD-0117 and TDD-0121 stay
...
| CR-20260925-0020 | `.qfai/contracts/cli/qfai-workflow.md`; `spec-0013/05_Examples.md`, `06_Test-Cases.md`                                                                                    | re-derive    | user                                                           | 2026-09-25T02:36:35Z |
...
- `AC-0013-0029`, `AC-0013-0030`, `BR-0013-0022`, `BR-0013-0023`, `EX-0013-0022`, `EX-0013-0023`,
  `TC-0013-0038` and `TC-0013-0039` became `AC-0013-0044`, `AC-0013-0045`, `BR-0013-0037`,
  `BR-0013-0038`, `EX-0013-0036`, `EX-0013-0037`, `TC-0013-0052` and `TC-0013-0053`.
- `TDD-0112`..`TDD-0115` became `TDD-0131`..`TDD-0134`, so the first four rows the second
  bullet moved are now `TDD-0131`..`TDD-0134`.
- The intent-driven entry's `DELTA-0001`..`DELTA-0005` became `DELTA-0004`..`DELTA-0008`.
