...
| 2026-05-04 | adopted     | AC-0013-0012, BR-0013-0009, EX-0013-0009, TC-0013-0014, TC-0013-0015, AD-0013-0005 | PR #206 commit 465b9869 — Triage cell escape ↔ parse symmetry を BR として明文化。`escapeTableCell` から `\` → `\\` 段を削除し、parser 側 (`splitMarkdownRow`) と対称化 (Option 1)。allowed cell character set に literal `\` を含めることを spec レベルで宣言し、trace chain (REQ → Spec → Code → Test) を round-trip identity property test に対して閉じる。AC-0013-0012 に Type=normal の TC-0013-0015 (happy path) と Type=edge の TC-0013-0014 (escape edge cases) を組み合わせ、BR-0013-0008 の「各 AC は normal + non-normal TC を最低 1 つずつ持つ」要求を満たす |
