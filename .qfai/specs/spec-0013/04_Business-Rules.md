...
## BR-0013-0021: Optional Side Artifacts Do Not Decide Preflight

- AC-Refs: AC-0013-0028

- The SDD preflight result MUST NOT depend on whether an optional side artifact is present, absent, malformed or in the old format.
