...
## AC-0013-0028: Optional Side Artifact Does Not Block Preflight

- US-Refs: US-0013-0008
- Given a discussion pack whose required markdown is complete and whose optional side artifacts are absent, malformed or in the old format,
- When SDD preflight runs,
- Then the side artifacts alone do not block SDD.
