...
> `validateDesignContractReadiness` family. The retirement keeps the
> requirements table aligned with the AC / BR / EX / TC / TDD layers,
> all of which had their corresponding rows removed in this PR.
