...
| BR-0002-0016 | Sidecar 11 ファイル完全性 (3-layer) | AC-0002-0009               | UI-bearing 検出時、uiux/ に 3-layer canonical family の 11 ファイル全てを生成。部分生成は不可。旧 4-axis ファイルは生成しない                                                                                                        | 00_index ~ 50_review_bundle            |          |
...
| BR-0002-0022 | Screen contract 10 field names      | AC-0002-0015               | 10 必須フィールド: screen_id, route, purpose, actor, primary_tasks, required_states, transitions, observable_outcomes, notes_for_verify, notes_for_reviewer                                                                          | 旧 spec-0034 統合元BR                  |          |
...
| BR-0002-0027 | 旧 4-axis ファイル forbidden        | AC-0002-0019               | uiux/ ディレクトリに 20_eval_axis_usability.md, 21_eval_axis_consistency.md, 22_eval_axis_accessibility.md, 23_eval_axis_delight.md のいずれかが存在する場合は error。31_anchor.md, 60_critique_loop.md も同様                       | D-004、REQ-0018                        | NFR-0005 |
