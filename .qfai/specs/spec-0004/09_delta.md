...
- Items appended: US-0004-0040; AC-0004-0040..AC-0004-0043;
  BR-0004-0034..BR-0004-0037, each contract-backed. The examples and test cases
  follow from EX-0004-0042 and TC-0004-0074. No existing item changes.
...
- Policy: `_policies/08_Decisions.md` DR-0296, cited in `01_Spec.md`
...
- Tags: @docs, @test
- Summary: AC-0004-0041 gains one outcome, that a reference on an
  approval-required row other than a `CREATE` fails `Operation`. BR-0004-0035
