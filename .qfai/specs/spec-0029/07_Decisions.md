...
- Rationale: The steering documents define 3-layer as the agreed final architecture. The legacy 4-axis model (usability, consistency, accessibility, delight) is an implementation artifact and must not persist as the scoring structure. Re-mapping is required to maintain alignment between spec, rubric, and implementation.
