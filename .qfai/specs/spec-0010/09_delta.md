...
| --- | --- | --- | --- | --- | --- | --- | --- |
| CR-20260912-0003 | Narrow the direction rule to screen exploration winners | spec-0010 | UPDATE | MODIFY | user (Codex interactive decision) | Re-derive US-0010-0008, AC-0010-0006, BR-0010-0006, EX-0010-0006 and TC-0010-0006. Discussion records the user's brand direction while screen explorations remain open until prototyping. Reset TDD-0006, TDD-0007, TDD-0008 and TDD-0010 to todo; none of their old evidence proves the narrowed boundary. | - |
| CR-20260912-0003 | Assign root DESIGN.md authorship to SDD Phase 0 | spec-0010 | UPDATE | MODIFY | user (Codex interactive decision) | Re-derive US-0010-0009, AC-0010-0007, BR-0010-0007, EX-0010-0007 and TC-0010-0007. Discussion supplies the user-chosen brand input; SDD Phase 0 authors root DESIGN.md and its lock before downstream use. Reset TDD-0011 to todo. | - |

This spec's two chains are re-derived before spec-0002's companion direction update under the same approved Change Request. The ledger-shape repair and missing story E2E rows remain prerequisites to Phase 2b.
