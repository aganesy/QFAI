...
| BR-0038-0003 | Source C: timestamp比較        | AC-0038-0001, AC-0038-0003 | evidence ファイルの mtime とspecファイルの mtime を比較し、stale specを検出する。evidence ファイルが存在しない場合はスキップする | git不在時の主要ソース                      | NFR-0001, NFR-0003 |
| BR-0038-0004 | Source D: delta.md パース      | AC-0038-0001, AC-0038-0003 | `09_delta.md` の変更サマリからコンテキスト情報を取得する                                                                         | git不在時のバックアップ                    | NFR-0001           |
| BR-0038-0005 | 統合判定                       | AC-0038-0001, AC-0038-0002 | `changed_specs = Source A ∪ Source B ∪ Source C ∪ Source D` で統合し、各specを `changed/stale/unchanged` に分類する              | union戦略                                  | NFR-0001           |
