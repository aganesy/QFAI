...
- In [v1.7.7 Mode Switch UX]: discussion artifact mode recommendation, mode precedence resolution (CLI > discussion > system default=standard), effective mode logging, non-visual surface mode behavior
...
- Out [v1.7.7 Mode Switch UX]: allowed_modes governance constraints (deferred), auto-detecting surface type from project
...
- DR-0084 [v1.7.7 Mode Switch UX]: Default mode override to standard — system default changed from low-cost to standard; precedence chain (CLI > discussion recommendation > system default)

## Entry points

- US range in this spec: US-0006-0001..US-0006-0013
