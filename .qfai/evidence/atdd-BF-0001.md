...
The flow owns 213 US, 462 AC and 750 EX rows. The [BF E2E test](../../packages/qfai/tests/e2e/bf0001DevelopVerifyFlowE2E.test.ts) has the matching annotation and observable assertions across the development and verification flow. This record does not claim a current test-suite run or reviewer sign-off.
