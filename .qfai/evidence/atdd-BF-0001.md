...
The flow owns 189 US, 333 AC and 484 EX rows. The [BF E2E test](../../packages/qfai/tests/e2e/bf0001DevelopVerifyFlowE2E.test.ts) has the matching annotation and observable assertions across the development and verification flow. This record does not claim a current test-suite run or reviewer sign-off.
...
[coverage-depth-BF-0001.md](coverage-depth-BF-0001.md) — ✅ 0 / ⚠️ 119 / ❌ 2141. The counts cover scored cells; `—` means the row has no declared case in that dimension.
