...
node packages/qfai/dist/cli/index.mjs validate --profile atdd --fail-on error --spec 0017
  ...
  side effect:        the command REWRITES `.qfai/report/validate.log`, which is tracked — and so <!-- qfai:not-a-citation -->
...
e2e callsites at this tree: 2066 (packages/qfai/tests/assets 1896, packages/qfai/tests/e2e 170)
