...
found both halves. The script now exists as `scripts/check-atdd-annotation-ledger.mjs` with 46 tests
...
- **new** `packages/qfai/tests/integration/scripts/checkAtddAnnotationLedger.test.ts` — 46 tests
