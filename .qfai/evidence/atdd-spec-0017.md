...
now 31 callsites under the e2e project's `tests/assets/**` glob and the one e2e-project file this
tree does not share with `main`, taking the count from `main`'s 927 to 958. Nothing about
`spec-0017` changed again, and neither suite total above was re-run for this tree — the line below is
what records that, exactly as the mechanism after it describes.

e2e callsites at this tree: 958
