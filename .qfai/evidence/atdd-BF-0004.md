...
✅ 0 / ⚠️ 50 / ❌ 289 across 339 scored cells; 423 cells are not applicable.
...
- The implementation layer adds [bf0004Examples.test.ts](../../packages/qfai/tests/unit/bf0004Examples.test.ts) with assertions for 17 EX IDs. Their exercised axes are ⚠ until CI executes the file; the remaining EX obligations stay ❌ with the implementation owner.
