...
✅ 0 / ⚠️ 75 / ❌ 264 across 339 scored cells; 423 cells are not applicable.
...
- The implementation layer adds [bf0004Examples.test.ts](../../packages/qfai/tests/unit/bf0004Examples.test.ts) and annotates existing migration unit tests for 42 EX IDs. Their exercised axes are ⚠ until CI executes the files; the remaining EX obligations stay ❌ with the implementation owner.
