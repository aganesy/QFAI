...
The flow owns 24 US, 63 AC and 119 EX rows. The [BF E2E test](../../packages/qfai/tests/e2e/bf0002CiReleaseFlowE2E.test.ts) has the matching annotation and observable assertions. This record does not claim a current test-suite run or reviewer sign-off.
...
[coverage-depth-BF-0002.md](coverage-depth-BF-0002.md) — ✅ 0 / ⚠️ 96 / ❌ 502. The counts cover scored cells; `—` means the row has no declared case in that dimension.
