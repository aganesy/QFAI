...
[coverage-depth-BF-0002.md](coverage-depth-BF-0002.md) — ✅ 0 / ⚠️ 72 / ❌ 514. The counts cover scored cells; `—` means the row has no declared case in that dimension.
