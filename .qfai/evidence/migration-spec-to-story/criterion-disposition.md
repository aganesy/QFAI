...
plan without a source-backed decision. The original source is archived under
`retired/spec-NNNN/03_Acceptance-Criteria.md`. No row below was dropped by
step 5.
...
`ac-semantic-map.csv`, an unchanged copy of the P7 semantic-review audit. Prose
