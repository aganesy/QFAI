...
### DR-0010-0007: Assign each discussion output to one acceptance criterion

- Date: 2026-09-24
- Status: Adopted

AC-0010-0001 owns only `uiux/40_screen_contracts.md` under US-0010-0006. AC-0010-0005 owns the existence and best-of-history content of `uiux/50_review_input_bundle.md` under US-0010-0007. AC-0010-0007 owns root `DESIGN.md` under US-0010-0009. AC-0010-0008 owns legacy sidecar absence under US-0010-0010. This preserves each output while giving the story-tree migration one parent and one verification chain per criterion.
