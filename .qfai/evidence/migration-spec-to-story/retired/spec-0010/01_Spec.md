...
- Evidence: SKILL.md at `packages/qfai/assets/init/.qfai/assistant/skills/qfai-discussion/SKILL.md` (with the `rule/ skill/ agent/ prompt/` assistant tree, `packages/qfai/assets/init/.qfai/assistant/skill/qfai-discussion/SKILL.md`)
- Evidence: pack templates at `packages/qfai/assets/init/.qfai/assistant/skills/qfai-discussion/templates/` (with the `rule/ skill/ agent/ prompt/` assistant tree, `packages/qfai/assets/init/.qfai/assistant/skill/qfai-discussion/templates/`)
...
- discussion-20260923063306456#REQ-0017, discussion-20260923063306456#REQ-0018: the skill paths this spec cites follow the singular `rule/ skill/ agent/ prompt/` assistant tree
