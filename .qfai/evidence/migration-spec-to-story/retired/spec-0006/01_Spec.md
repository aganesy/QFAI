...
- discussion-20260923063306456#REQ-0001: Story-based spec tree - `paths.specsDir` defaults to `.qfai/spec`; doctor's directory and path checks read it from the configuration
- discussion-20260923063306456#REQ-0005: Contract layer - `paths.contractsDir` defaults to `.qfai/spec/03_contract`
- discussion-20260923063306456#REQ-0013: Abolished artifacts - the capability catalog goes, and with it doctor's check of that catalog
- discussion-20260923063306456#REQ-0018: Singular directory names - the skill tree is `.qfai/assistant/skill/`, which the manifest probe reaches through `paths.skillsDir`
