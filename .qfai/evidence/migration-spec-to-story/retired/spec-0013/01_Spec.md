...
- discussion-20260923063306456#REQ-0001: Story-based spec tree -- `/qfai-sdd` writes the `.qfai/spec/` tree; the scoped completion gate takes `--flow BF-NNNN`
- discussion-20260923063306456#REQ-0002: Policy layer -- `01_policy/` files written from their templates
- discussion-20260923063306456#REQ-0003: Business-flow layer -- flow and story directories; a story directory holds exactly three files
- discussion-20260923063306456#REQ-0004: ID grammar -- BF, US, AC, EX, BR, DEC and OQ IDs allocated as the highest in scope plus one
- discussion-20260923063306456#REQ-0005: Contract layer -- every contract file has a row in `contracts.md`; `tech.md` holds the quality-gate commands
- discussion-20260923063306456#REQ-0006: Business rules inside contracts -- one definition per rule, referenced by ID elsewhere
- discussion-20260923063306456#REQ-0007: BR and EX coverage -- every BR cites an EX and every EX is cited by a BR
- discussion-20260923063306456#REQ-0008: EX and AC link -- each EX cites exactly one AC and every AC has an EX
- discussion-20260923063306456#REQ-0011: Decision and open-question tables -- four columns, fixed Status vocabulary, rows only appended
- discussion-20260923063306456#REQ-0012: Triage, change requests, retired stories -- rows of `decisions.md`; nothing under `.qfai/decisions/`
- discussion-20260923063306456#REQ-0013: Abolished artifacts -- the spec-pack phases, capability batch mode and `spec-XXXX` generation retire; the scoped gate moves off `--spec`
- discussion-20260923063306456#REQ-0014: Concrete-first order -- 01 policy -> 02 business flow -> stories -> 03 contract with BRs; no Contracts-first phase
- discussion-20260923063306456#REQ-0017: Assistant tree reorganisation -- `change-classification.md` in `rule/`, `requirements-decomposition.md` in the `qfai-sdd` references
- discussion-20260923063306456#REQ-0022: Layout described by mdschema -- each tree file has a paired template
- discussion-20260923063306456#REQ-0023: No duplicate content in the merges -- the five merged files state each fact once
