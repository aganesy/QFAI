...
- Status: Superseded by DR-0008-0004 for story-tree identities; the validate-cycle threshold remains.
...
### DR-0008-0004: Scaffold idempotency and escalation use AC or BF identities

- Date: 2026-09-24
- Status: Adopted

The P7 scaffold takes `--story US-NNNN-NNNN` or `--flow BF-NNNN`; the old `--spec` and TC-file shape is retired. Re-running a target never overwrites an existing skeleton, including one still carrying a placeholder. `D-SCAFFOLD-PLACEHOLDER` remains a warning for the first two consecutive validate cycles with that placeholder and becomes an error on the third by default, keyed by AC ID for a story skeleton and BF ID for a flow skeleton. The command's own scaffold-run attempt counter is separate from the validate-cycle counter. AC-0008-0011, BR-0008-0009, EX-0008-0010 and TC-0008-0014 retain their IDs and point to this current outcome.
