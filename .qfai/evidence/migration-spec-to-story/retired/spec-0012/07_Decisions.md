...
- Status: Superseded at P7 by DR-0012-0033.
...
### DR-0012-0033: Retire legacy validator, ID reservation, and fixed skill budget criteria

- Decision: P7 retires AC-0012-0008 with BR-0012-0008, AC-0012-0010 with BR-0012-0010, and AC-0012-0031 with BR-0012-0025. EX-0012-0102 and TC-0012-0313 retire with the first two; EX-0012-0121, TC-0012-0337, and TDD-0346 retire with the fixed size budget. The migration ID map and decision provenance retain old IDs without making their reservation a prototyping runtime criterion.
- Context: The old validator slice is expressly history-only. The shipped prototyping skill now exceeds 130 lines and its references were reorganized; the numeric budget does not describe the accepted package. The old ID reservation has no observable prototyping result.
- Rationale: Keep current skill behavior complete and readable under shipped asset and documentation gates. Do not assert an obsolete line ceiling or expose history-only validators as a product mode. DR-0012-0019 is superseded.

### DR-0012-0034: Split the cycle-0 freeze criterion by story

- Decision: AC-0012-0051 belongs to US-0012-0116 and requires the frozen UI contract set in `uiContractsCovered[]`. AC-0012-0083 belongs to US-0012-0117 and requires the frozen stock-photo license catalog. Both cite BR-0012-0040, which is one cycle-0 persistence rule with two independent obligations. EX-0012-0143 and TC-0012-0388 cover the former; EX-0012-0144 and TC-0012-0389 cover the latter. TC-0012-0390 checks both.
- Rationale: Each acceptance criterion has one story parent and a concrete observable result. The split preserves both parts of the former combined AC-0012-0051 without inventing a second freeze rule.
...
### DR-0012-0032: One current missing-evidence obligation

- Date: 2026-09-24
- Decision: BR-0012-0060 and AC-0012-0072/0073 own the post-convergence screenshot and HTML `evidenceRefs[]` obligation. The former per-iteration capture-failure rule is retired at the story-tree cutover.
- Why: EX-0012-0002/0003 and TC-0012-0291 already mark the capture-script behavior superseded. Restating its fail-closed meaning as a second rule would duplicate BR-0012-0060 and retain the obsolete `QFAI-UIE-001/002` path.
- Rejected: Requiring PNG and HTML files for every reviewer cycle or reviving `capture-screenshots.js` to satisfy the old rule.
- Follow-up: The P7 cutover retires BR-0012-0003, AC-0012-0003, EX-0012-0002/0003, and TC-0012-0291. It preserves the old source in the migration archive.
