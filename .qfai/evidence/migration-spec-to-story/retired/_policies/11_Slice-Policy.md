...
| skill      | 1 skill = 1 spec                  | spec-0008..0014, spec-0016, spec-0018 |
...
- `spec-0018` is a late-added skill spec at the end of the skill category
  (`CAP-0018` = the `qfai-migration-spec-to-story` skill).
- The active range is `spec-0001..spec-0018`, with no gap. That meets the
  sequence the positional validator (`QFAI-SPLIT-102..105`) requires.
