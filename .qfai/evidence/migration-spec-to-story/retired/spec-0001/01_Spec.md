...
- discussion-20260923063306456#NFR-0006: Layout has one description — `mdschemaSchemas.test.ts` has no failure, and
  `pnpm lint:mdschema` and `pnpm lint:mermaid` pass on the sample tree
...
- REQ-0008: Skill orchestration uses the installed package's skill inventory and resolved routing; no fixed skill count is a contract.
- REQ-0009: Steering & Governance — Steering/Instructions 文書構造、Review Roster、Constitution、Canonical Workflow Stages
- discussion-20260923063306456#REQ-0001: Story-based spec tree
- discussion-20260923063306456#REQ-0002: Policy layer
- discussion-20260923063306456#REQ-0003: Business-flow layer
- discussion-20260923063306456#REQ-0004: ID grammar
- discussion-20260923063306456#REQ-0005: Contract layer
- discussion-20260923063306456#REQ-0006: Business rules inside contracts
- discussion-20260923063306456#REQ-0007: BR and EX coverage
- discussion-20260923063306456#REQ-0008: EX and AC link
- discussion-20260923063306456#REQ-0009: Test annotation layers
- discussion-20260923063306456#REQ-0011: Decision and open-question tables
- discussion-20260923063306456#REQ-0012: Triage, change requests, retired stories; the drift protocol's change request
- discussion-20260923063306456#REQ-0013: Abolished artifacts — retires this spec's spec-pack items
- discussion-20260923063306456#REQ-0017: Assistant tree reorganisation
- discussion-20260923063306456#REQ-0018: Singular directory names
- discussion-20260923063306456#REQ-0022: Layout described by mdschema

## Entry points

- US range in this spec: US-0001-0001..US-0001-0017
