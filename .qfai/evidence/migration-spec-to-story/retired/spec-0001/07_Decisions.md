...
### DR-0001-0003: Package-owned skill inventory

- Date: 2026-09-24
- Decision: The installed package's `assistant/skill/*/SKILL.md` files define the shipped skill inventory. `assistant-routing.md` defines how that inventory is selected. No fixed skill count is an interface requirement.
- Why: The former nine-skill list and its three deprecated TDD entries do not match the package's current contents. Keeping either as an active rule would make a successful installation violate its own specification.
- Rejected: Carrying the old nine-entry catalog or recreating absent TDD skills to satisfy its count.
- Follow-up: The P7 cutover retires BR-0001-0020/0022, AC-0001-0010, EX-0001-0016/0018, and TC-0001-0016/0018. The migration guide explains the former skill names.
