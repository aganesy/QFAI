...
# AC-0017-0034: The mapping file has one copy, reached from the asset tree and from the root
# Parent: US-0017-0009
...
# AC-0017-0037: The mirror links the renamed tree, and a retired name is drift
# Parent: US-0017-0010
# Source: discussion-20260923063306456#NFR-0009
...
# AC-0017-0038: The shape table lists the new ID shapes in the guards' pull request
# Parent: US-0017-0011
# Source: discussion-20260923063306456#REQ-0024
...
# AC-0017-0039: A cost claim without before-and-after measurements is refused
# Parent: US-0017-0004
# Source: discussion-20260804173914356#OC-80
...
# AC-0017-0040: The code-path cost pin matches the workflow tree
# Parent: US-0017-0005
# Source: discussion-20260804173914356#NFR-0002
...
| AC-0017-0037 | The mirror links the renamed tree, and a retired name is drift     | Normal plus error (retired name), US-0017-0010, REQ-0016                        | Must     |
| AC-0017-0038 | The shape table lists the new ID shapes with the guard change      | Normal plus boundary (same pull request), US-0017-0011, REQ-0017                | Must     |
| AC-0017-0039 | A cost claim without measurements is refused                       | Error path, US-0017-0004, REQ-0005                                              | Must     |
| AC-0017-0040 | The code-path cost pin matches the workflow tree                   | Normal and error paths, US-0017-0005, REQ-0008                                  | Must     |
