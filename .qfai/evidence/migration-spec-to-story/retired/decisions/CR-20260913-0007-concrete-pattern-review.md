...
The P6 spec-to-story REMOVE row retires the old review-gate catalog bound,
the preserved numeric-target oracle and TDD-0039. TDD-0007 retains the
abstract-only N/A boundary. The surviving concrete proposal, rationale,
mandatory-pairing and reviewer-gate acceptance signals still require current
test and owner-review evidence. This landing alone does not set `Applied at`
or close the change request (OQ-0184).
