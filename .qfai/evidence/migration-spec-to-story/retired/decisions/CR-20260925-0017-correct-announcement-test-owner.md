...
This record was raised as `CR-20260925-0003`. The main branch gives that ID to another
record, so this one is `CR-20260925-0017`.
...
- Related CR: `CR-20260924-0008` names the same ledger but does not block `TDD-0014`. It was applied before this owner rerun.
...
1. On approval and after `CR-20260924-0008` is applied, run `/qfai-sdd spec-0018` Phase 2b in `re-derive` mode for the ledger owner field. Record this correction in `spec-0018/09_delta.md`.
...
`CR-20260924-0008` was applied, `/qfai-sdd spec-0018` ran in `re-derive` mode
