...
This record was raised as `CR-20260925-0006`. The main branch gives that ID to another
record, so this one is `CR-20260925-0020`.
...
| `TC-0013-0052` | `spec-0013/TDD-0131` | CLI-WF `## Authorizations`                     |
| `TC-0013-0053` | `spec-0013/TDD-0132` | CLI-WF, for the staleness conditions           |
...
| `spec-0013/TDD-0131`                   | `ledger-row` | `TC-Refs` names `TC-0013-0052` |
| `spec-0013/TDD-0132`                   | `ledger-row` | `TC-Refs` names `TC-0013-0053` |
...
- Specs: `spec-0011` `AC-0011-0020`, `BR-0011-0017`, `EX-0011-0018`,
  `TC-0011-0021`; `spec-0013` `EX-0013-0026`, `TC-0013-0052`, `TC-0013-0053`,
...
3. Downstream ledger sweep:
   - Reset to `todo`, recording this CR's ID in their `DR-ID` column:
     `spec-0011/TDD-0029`, `spec-0013/TDD-0131`, `spec-0013/TDD-0132`,
...
- **A.** `TC-0011-0021`, `EX-0011-0018`, `AC-0011-0020` and `BR-0011-0017`
  ...
  the row, instead of citing `DR-0297`. `TC-0013-0052` requires the check to be
  stated: the record exists, matches the row's operation and capability, and is
  not stale. `TC-0013-0053` requires the three staleness conditions to be
