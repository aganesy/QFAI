...
- REQ-0040: ガードレール一覧 - `qfai guardrails list` で policy と contract の明示的な `DG-NNNN` 項目を一覧表示する。RFC 2119 の語から自動抽出しない
...
- REQ-0044: 複数パス指定 - `--path` を繰り返して検索対象パスを複数指定できる
- discussion-20260923063306456#REQ-0001: Story-based spec tree - the specification lives under `.qfai/spec/`, with no `_policies/` and no spec packs
- discussion-20260923063306456#REQ-0002: Policy layer - policy and constraints live in `01_policy/`
- discussion-20260923063306456#REQ-0005: Contract layer - contracts live in `03_contract/`, the directory `paths.contractsDir` names
