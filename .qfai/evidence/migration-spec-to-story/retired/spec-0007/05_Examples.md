...
| ------------ | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| EX-0007-0001 | BR-0007-0001 | `<paths.specsDir>/01_policy/` に明示的な `DG-0001` が1件と `MUST` だけを含む別の文がある                                                                         | `DG-0001` のみ検出され、`MUST` の文は項目にならない                           |
| EX-0007-0002 | BR-0007-0002 | `qfai guardrails list`                                                                                                                                 | `DG-0001` と `non-goal`、文面、根拠、再検討条件、ソースが出力される          |
...
| EX-0007-0009 | BR-0007-0009 | `qfai guardrails list --path /nonexistent`                                                                                                             | エラーメッセージ表示、exit 2                                               |
| EX-0007-0012 | BR-0007-0001 | On the story tree, `qfai guardrails list` with explicit `DG-0001` and `DG-0002` entries under `<paths.specsDir>/01_policy/` and `<paths.contractsDir>/` | Both entries retain their ID, type, rationale, reconsideration condition, and source file |
