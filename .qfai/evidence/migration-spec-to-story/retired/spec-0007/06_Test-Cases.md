...
| TC-0007-0012 | integration | AC-0007-0001 | EX-0007-0012 | Guardrail detection from the story tree |
...
## TC-0007-0012: Guardrail detection from the story tree

**Level:** integration
**EX Refs:** EX-0007-0012
**AC Refs:** AC-0007-0001

Setup: On the story tree, place one guardrail definition in a Markdown file under `<paths.specsDir>/01_policy/` and one under `<paths.contractsDir>/`.
Action: Run `runGuardrails({ root, action: 'list', paths: [] })`.
Verify:

- both guardrails are listed
- each listed guardrail names the file it was read from
