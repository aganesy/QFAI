...
- Discussion pack `discussion-20260923063306456` (spec-to-story restructure):
  - `discussion-20260923063306456#REQ-0001`, `discussion-20260923063306456#REQ-0011`, `discussion-20260923063306456#REQ-0013`: the `/qfai-verify` references drop the TC chain and the ledger, load the story-tree directories, and read decisions from `decisions.md`
  - `discussion-20260923063306456#REQ-0016`, `discussion-20260923063306456#REQ-0017`: `/qfai-verify` loads the constitution from `rule/` and its routing and review settings from the built-in defaults and `qfai.config.yaml`
