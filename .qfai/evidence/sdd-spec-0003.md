...
- `.qfai/specs/spec-0003/tdd/test-list.md` (Phase 2b): TDD-0022 deleted and
  tombstoned under a new `## TDD-ID reservations`; TDD-0092 to TDD-0097 seeded
...
- Test-design review fix, cycle 1 (`test-design-analyst`, `tda-reviewfix`):
  TC-0003-0059..0061 and TDD-0092..TDD-0097 were reviewed for Level, Type,
...
| 8    | requirements-reviewer | p2-griller           | grilling(2/agents): six ledger rows TDD-0092..0097                                                                                                                                                 | S3-D8                                                                                 | One row per independently failing part; author agreed                                                                                                                                                                                                                               | PASS                         |
...
| 28   | test-design-analyst   | tda-reviewfix        | Test-design review fix, Reviewer Gate cycle 1 (F-B2)                                                                                                                                               | `.qfai/specs/spec-0003/03..06`, `tdd/test-list.md`, `09_delta.md`; cycle-1 R01/R03    | No correction. TC-0003-0059..0061 and TDD-0092..TDD-0097 hold; the TDD-0022 retirement record names every annotated test                                                                                                                                                            | PASS                         |
