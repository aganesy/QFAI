...
- Objective: apply `CR-20260923-0004` in mode `re-derive`. AC-0004-0041,
...
- DR-0004-0043 / DL-0029: a `blocked` row passes on a well-formed
  `Blocked-By` — the check the spec keeps, stated as it is (CR-20260923-0004).
...
| ----- | ------- | -------- | -------------------- | ----------------------------------- | -------- |
| 2     | skipped | -        | 2026-09-23T20:05:55Z | empty: answered by CR-20260923-0004 | -        |
...
| ---- | -------------------- | ---------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ---------------------------- |
| 1    | requirements-analyst | cr-0004-author         | Change Request for the `Blocked-By` defect                                | `/qfai-atdd` run key `2026-09-23T19:33:24.738Z`; EX-0004-0044; BR-0004-0035; `tddList.ts` | `CR-20260923-0004`, Class `defect`, approved by yusuke_senaga                                    | PASS                         |
| 2    | requirements-analyst | cr-0004-author         | Phase 2 re-derive: AC-0004-0041, BR-0004-0035, EX-0004-0044, TC-0004-0076 | `CR-20260923-0004` `## Proposed change`                                                   | Files under Work performed; DR-0004-0043; validate sdd `--spec spec-0004`: 0 errors              | PASS                         |
...
| 4    | completion-reviewer  | gate-cr0004-completion | Reviewer Gate for this rerun                                              | this section, `CR-20260923-0004`, `.qfai/specs/spec-0004/**`                              | `review-20260923201700600` R01: PASS, advisories A1-A3 only; `summary.json` overall PASS         | PASS                         |
