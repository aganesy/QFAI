...
- Tests: `spec-0013/TDD-0027`, `spec-0013/TDD-0028`, `spec-0004/TDD-0050`; under
  ...
  whose skipped cases require the finding to name `3..7`, with the new `E2E`
  tests the `/qfai-atdd spec-0004` pass writes under
  ...
  `.qfai/evidence/coverage-depth-spec-0004.md`; under every option, the new
  `E2E` tests the `/qfai-atdd spec-0013` pass writes for `US-0013-0001` to
  `US-0013-0010`, the tests for `spec-0013/TDD-0016` to `TDD-0018`, and
