...
| Scoring Axes            | Three-layer evaluation framework: invariant (universal UX principles), trend-derived (current design trends), product-specific (project-unique criteria) | uiux/20-23*design_eval*\*.yaml       |
