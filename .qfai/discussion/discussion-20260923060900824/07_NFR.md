...
| NFR-0003 | reliability     | No data loss in an adopter's tree             | 0 files deleted or changed under `.qfai/steering/`; an edited `catalog/worklog-entry.schema.md` is kept                                                                                                                                                                                                                                                              | Integration test: hash every file before and after `qfai init` and `qfai init --force`; hashes match, and the edited schema copy is present with the retire-pass note                                     | SRC-0004, SRC-0006           | must     |
