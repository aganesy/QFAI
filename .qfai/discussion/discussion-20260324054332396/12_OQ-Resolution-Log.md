...
| ---- | ---------------- | ---------- | ------------ | ------------- | -------------------- |
| 1 | orchestrator | OQ hearing log | OQ register, source evidence | `12_OQ-Resolution-Log.md` | PASS |
| 2 | reviewer | Future audit basis | Resolution log | Reviewable timeline | PASS |
