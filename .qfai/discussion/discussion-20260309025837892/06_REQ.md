...
| REQ-0012 | Escalation Hook定義 | spec-XXXX/01_Spec.mdから_policiesへの参照委譲メカニズム（NFR/policy/requirements/evidenceのcopy-down）をspec-0009で定義する | SRC-0019, SRC-0023 | must | draft |
