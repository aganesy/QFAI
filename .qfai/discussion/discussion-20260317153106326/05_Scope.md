...
| 4   | .qfai/specs/README.md documentation update | Document test-list.md as execution ledger, coverage definition, exception/DR-ID contract, and test file existence requirement                 |
...
1. **All 5 Phase 2 error checks pass/fail correctly** — each check emits the expected error for its failure mode (F-6101, F-6102, F-6103, F-6106, F-6107) and passes for valid input.
