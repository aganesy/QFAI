...
- `--force` rewrites `.github/copilot-instructions.md` without asking. Keep local
  edits out of it; the flag's table under
  [What you can do](#what-you-can-do-cli-commands) lists exactly what it owns.
