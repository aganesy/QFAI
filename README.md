...
`.github/**`, and `.codex/**`.
Into `.github/workflows/` it writes exactly three files — `qfai-validate.yml`,
`qfai-tests.yml` and `qfai-docs.yml` — and touches nothing else there; all three
open with a `# Generated by \`qfai init\`` line. Configure the rest of CI in your
own platform and run:
